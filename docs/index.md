...
<a href="mailto:email@email?subject=SupportRequest" target="_blank" title="Click Here to rasie a support ticket" class="md-button-support md-button md-button--primary">
